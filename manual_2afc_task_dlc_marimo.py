...
def _(
    ...
    def combine_trial_dfs():
        ...
        for condition_name, condition_dic in [
            ...
            for pair_id, trial_df in condition_dic.items():
    ...
    def performance_rows_by_column(trial_df, split_column):
        ...
        rows = []
        for group_key, session_df in trial_df.groupby(
            group_columns,
            sort=True,
            dropna=False,
        ):
    ...
    def plot_group_condition_column(
        ...
        x_positions = {"true": 1, "all": 2, "false": 3}
        colors = {
            "true": "#2A9D8F",
            "all": "#6C757D",
            "false": "#E76F51",
        ...
        boxplot = ax.boxplot(
            data,
            positions=[x_positions[label] for label in split_labels],
            labels=split_labels,
            patch_artist=True,
            showmeans=True,
            showfliers=False,
